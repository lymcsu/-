...
function getStockOpt(id,name){
	...
	$(".areaText").val(currentAreaInfo.currentProvinceName+cleanKuohao(currentAreaInfo.currentCityName)+cleanKuohao(currentAreaInfo.currentAreaName)+cleanKuohao(currentAreaInfo.currentTownName)).attr("title",address);
...
$("#store-selector .select-input-select-btn_icon").after(provinceHtml);
